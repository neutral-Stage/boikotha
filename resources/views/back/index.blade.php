                            ...
                            <div class="ibox-body">
                                ...
                                <table class="table table-striped m-t-20 visitors-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('back') }}/assets/img/flags/us.png" />USA</td>
                                            <td>755</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('back') }}/assets/img/flags/Canada.png" />Canada</td>
                                            <td>700</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('back') }}/assets/img/flags/India.png" />India</td>
                                            <td>410</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('back') }}/assets/img/flags/Australia.png" />Australia</td>
                                            <td>304</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('back') }}/assets/img/flags/Singapore.png" />Singapore</td>
                                            <td>203</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('back') }}/assets/img/flags/uk.png" />UK</td>
                                            <td>202</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('back') }}/assets/img/flags/UAE.png" />UAE</td>
                                            <td>180</td>
                                            <td>
                                                <div class="progress">
                                ...
                                <ul class="media-list media-list-divider m-0">
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{ asset('back') }}/assets/img/users/u1.jpg" width="40" />
                                        </a>
                                    ...
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{ asset('back') }}/assets/img/users/u2.jpg" width="40" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{ asset('back') }}/assets/img/users/u3.jpg" width="40" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{ asset('back') }}/assets/img/users/u6.jpg" width="40" />
                                        </a>
                                        <div class="media-body">
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <ul class="media-list media-list-divider m-0">
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img src="{{ asset('back') }}/assets/img/image.jpg" width="50px;" />
                                        </a>
                                        <div class="media-body">
